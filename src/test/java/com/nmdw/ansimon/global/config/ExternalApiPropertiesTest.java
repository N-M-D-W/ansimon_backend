...
class ExternalApiPropertiesTest {
    ...
    void exposesConfiguredExternalApiEndpoints() {
        ExternalApiProperties properties = new ExternalApiProperties(
                ...
                new ExternalApiProperties.Endpoint("http://localhost:9200", "guidance-key")
        );
        ...
        assertThat(properties.guidance().baseUrl()).isEqualTo("http://localhost:9200");
        assertThat(properties.guidance().apiKey()).isEqualTo("guidance-key");
    }
}
